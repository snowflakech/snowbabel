        ...
        callback: function(r, options, success) {
            ...
            if(ActionParams.ActionKey === 'LanguageSelection') {
                ...
                if(success) {
                    ...
                    TYPO3.Snowbabel.Generals.ShowMessage('success', TYPO3.lang.translation_msg_SaveOkTitle, TYPO3.lang.translation_msg_SaveOkMessage + ' ' + ActionParams.TranslationValue, 1);
                }
                else {
                    TYPO3.Snowbabel.Generals.ShowMessage('error', TYPO3.lang.translation_msg_SaveErrorTitle, TYPO3.lang.translation_msg_SaveErrorMessage + ' ' + ActionParams.TranslationValue, 3);
                }
            }
                ...
                if(!success) {
                    TYPO3.Snowbabel.Generals.ShowMessageBox(TYPO3.lang.translation_msg_ConfigurationTitle, TYPO3.lang.translation_msg_ConfigurationMessage, true, 75);
                }
...
TYPO3.Snowbabel.Generals.GeneralSettingsFormSubmit = function() {
    ...
    Form.submit({
        ...
        success: function(form, action) {
            TYPO3.Snowbabel.Generals.ShowMessage('success', TYPO3.lang.settings_msg_SubmitOkTitle, TYPO3.lang.settings_msg_SubmitOkMessage, 1)
        },

        failure: function(form,action) {
            TYPO3.Snowbabel.Generals.ShowMessage('error', TYPO3.lang.settings_msg_SubmitErrorTitle, TYPO3.lang.settings_msg_SubmitErrorMessage, 3)
        }
...
/**
 * Shows popup
 * @param severity (notice=notice, information=information, success=success, warning=warning, error=error)
 * @param title
 * @param message
